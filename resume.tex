...
\address{285b Crystal Palace Rd}{SE22 9JL}{London, United Kingdom \vspace{20pt}}
...
\cventry{2016 -- now}{Citadel Securities - Software Engineer}{London}{}{}{As part of the team maintaining the options trading platform, I built a generic framework for stream data processing and analytics in Python which has since been rolled out and is being used globally. Furthermore I designed, built and tested a new trading engine for option basket orders and was responsible for the development work driving the restructuring of the global options hedging strategies.}
...
%\cvitem{}{}
\cvitem{Programming}{C/C++, Python, x64 Assembly, VHDL, Bluespec SystemVerilog, Matlab, Java, JavaScript, SQL and HTML/CSS.}
